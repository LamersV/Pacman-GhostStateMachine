...
public class Game {
  ...
  private static int ghostLaunchTimeSpacing = 10; //mudar pra get
...
//            break;
//        }
        GhostPlayer ghost = null;
        GhostState state = null;
        switch (i){
          case 0:
            ghost = new StateGhostPlayer();
            name = "Alberto";
            state = Rotating.getInstance();
            color = Color.cyan;
            break;
          case 1:
            ghost = new StateGhostPlayer();
            name = "Arlindo";
            state = Stalking.getInstance();
            color = Color.pink;
            break;
          case 2:
            ghost = new StateGhostPlayer();
            name = "Cleitin";
            state = Drunk.getInstance();
            color = Color.green;
            break;
          case 3:
            ghost = new StateGhostPlayer();
            name = "Mauro";
            state = Defending.getInstance();
            color = Color.red;
            break;
        }
        ghost.setColor(color);
    ...
    // set up game
    game = new Game(ghostPlayers, display);
    // play
